    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h3>LOVE TO HEAR ABOUT OUR SERVICES!</h3>
            ...
            <div class="modal-body text-center"> <i class="far fa-file-alt fa-4x mb-3 animated rotateIn icon1"></i>
                ...
                <hr>
                <h6>How was our Services?</h6>
            </div> <!-- Radio Buttons for Rating-->
            <div class="form-check mb-4"> <input name="feedback" type="radio"> <label class="ml-3">Friendly</label> </div>
            <div class="form-check mb-4"> <input name="feedback" type="radio"> <label class="ml-3">Excellent</label> </div>
            <div class="form-check mb-4"> <input name="feedback" type="radio"> <label class="ml-3">Good</label> </div>
            <div class="form-check mb-4"> <input name="feedback" type="radio"> <label class="ml-3">Rude</label> </div>
            <div class="form-check mb-4"> <input name="feedback" type="radio"> <label class="ml-3">food was not on time</label> </div>


            <!--Text Message-->
            <div class="text-center">
                <h4>Things we need to improve?</h4>
